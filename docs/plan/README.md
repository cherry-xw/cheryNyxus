...
| 任务                                                                           | 状态       | 范围                                                           |
| ------------------------------------------------------------------------------ | ---------- | -------------------------------------------------------------- |
| [节点树与流程图分离、Pixi 主树恢复](main-agent-runtime-diagram/README.md) | 执行中 | Pixi 横向节点树为主界面，Vue Flow 流程图按需侧栏，订阅生命周期与旧交互恢复 |
| [万象台](wanxiangtai/README.md)                                                | 规划中     | 多 Agent 团队协作、独立工作区、交付集成与桌面呈现              |
| [工作台标题栏会话状态条](workbench-session-strip/README.md)                    | 执行中     | 标题栏活跃会话 icon 阵列 + 当前预设分页下拉，overview 订阅驱动  |
