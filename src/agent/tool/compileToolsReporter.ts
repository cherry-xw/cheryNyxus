...
import { runToolTests, type TestResultDetail } from "./index.js";
import type { CompiledToolInfo, ToolCompileSummary } from "@/core/tool/compiler/index.js";
...
export function reportToolCompileResult(
  summary: ToolCompileSummary,
...
export async function runToolTestsAndCollect(
  infos: CompiledToolInfo[],
  ...
  for (const info of infos) {
    ...
    try {
      ...
      const detail = await runToolTests(module.default, info.testCases);
