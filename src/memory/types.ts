 ...
 * 活跃记忆存 memories/<name>.md，淘汰归档到 history/memories/<name>.md（增加替换元数据）。
 */
...
/** 活跃记忆 frontmatter（memories/<name>.md） */
...
/** 历史记忆 frontmatter（history/memories/<name>.md）— 在活跃基础上增加淘汰元数据 */
