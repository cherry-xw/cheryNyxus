...
import type { RuntimeSelection } from '@/domain/chat/runtime'
...
export interface PetInstance extends PetPreset {
  instanceId: string
  /** 主体视觉类型；nyxus 已独立为核心（NyxusCore），不再经 PetInstance，此字段恒 'default'。 */
