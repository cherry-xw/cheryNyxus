...
export function spriteMotion(action: PetAction) {
  switch (action) {
    ...
    case "dragging":
      return { animate: { rotate: [-4, 4], scaleX: [1.03, 0.98] }, transition: tLoop(0.72, "reverse") };
    case "dropped":
      return { animate: { y: [0, -3, 0], rotate: [-3, 3, -3] }, transition: tLoop(0.76, "reverse", "easeOut") };
    case "clicked":
      return { animate: { y: [0, -4, 0], scaleY: [0.98, 1.03, 0.98] }, transition: tSpring(300, 12) };
    case "chatting":
...
export function handMotion(action: PetAction, side: Side) {
  ...
  const dur =
    action === "clicked" || action === "dragging" ? 0.5 : action === "hover" ? 0.6 : action === "chatting" ? 0.9 : action === "sleep" ? 3 : 1;
...
export function faceMotion(mood: PetMood) {
  switch (mood) {
    case "happy":
      return { animate: { scale: [1, 1.1, 1], filter: ["brightness(1)", "brightness(1.22)", "brightness(1)"] }, transition: tLoop(1.4) };
    case "angry":
      return { animate: { rotate: [-3, 3, -3], filter: ["brightness(1)", "brightness(1.35)", "brightness(1)"] }, transition: tLoop(0.6) };
    case "panicked":
      return { animate: { rotate: [-4, 4, -4], filter: ["hue-rotate(0deg)", "hue-rotate(40deg)", "hue-rotate(0deg)"] }, transition: tLoop(0.5) };
    case "surprised":
      return { animate: { scale: [1, 1.12, 1], filter: ["brightness(1)", "brightness(1.5)", "brightness(1)"] }, transition: tLoop(0.4) };
    case "sad":
      return { animate: { scale: [1, 0.98, 1], opacity: [1, 0.6, 1], filter: ["brightness(1)", "brightness(0.72)", "brightness(1)"] }, transition: tLoop(2.4) };
    case "sleepy":
