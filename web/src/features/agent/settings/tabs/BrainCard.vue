...
import type { BrainConfigDto, ConfigDto, MediaCapabilitiesDto } from "@/services/agentApi";
      ...
      <section class="brain-section">
        ...
        <div class="brain-fields connection-fields">
          ...
          <label class="field">
            ...
            <el-input v-model="cfg.model" class="mono-input" placeholder="gpt-3.5-turbo" />
          </label>
          ...
          <label class="field field-wide">
            <LabelTip label="门禁卡" tip="key：API 密钥，建议填 $ENV 走 .env 不明文" />
            <el-input v-model="cfg.key" class="mono-input" placeholder="$OPENAI_API_KEY" show-password />
          </label>
        </div>
      </section>
