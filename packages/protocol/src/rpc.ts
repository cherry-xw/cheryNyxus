...
export const Method = {
  ...
  CHAT_USAGE_DETAIL: 'chat.taskUsage.detail',
  CHAT_USAGE_SUMMARIES: 'chat.taskUsage.summaries',
  CHAT_USAGE_ROUNDS: 'chat.taskUsage.rounds',
  CHAT_USAGE_DAILY: 'chat.taskUsage.daily',
  CHAT_USAGE_DAY_TASKS: 'chat.taskUsage.dayTasks',
